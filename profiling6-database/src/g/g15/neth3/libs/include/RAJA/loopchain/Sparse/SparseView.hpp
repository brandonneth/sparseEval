...
/*
  ...
  auto impl = COO<ElmType, numDims>(indicesVector, val, permutation);  
...
template <typename T>
RAJA::SparseView<T,2> make_random_sparse_view2(camp::idx_t N, double density = 0.1, bool diagonal=false) {
